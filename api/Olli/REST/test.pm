package Olli::REST::test ;
# copied (and package name changed) from:
# /usr/local/share/perl/5.22.1/Apache2/REST/Handler/test.pm

# conf/olli.conf changed to point here as the Apache2RESTHandlerRootClass
